...
/// Re-reads `/vehicles/status`.
///
/// Raised on a timer so every page reading this bloc — Overview's map and
/// Live Tracking — sees the same rows refreshed at the same moment, instead
/// of each polling the endpoint on its own clock and drifting apart.
class VehicleStatusRefreshed extends DashboardEvent {
