                ...
                children: [
                            ...
                            (row) => Expanded(
                              child: Padding(
                                ...
                                child: _WeekdayStackBar(
                                  ...
                                  maxTotal: dataset.maxTotal.toDouble(),
                                ),
                              ),
                            ),
                          )
                  ...
                  const Row(
                    children: [
                      ...
                      SizedBox(width: 18),
                      _LegendDot(color: Color(0xFF5B6677), label: 'Others'),
                    ],
                  ),
                ],
              ),
...
class _WeekdayStackBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fullHeight = ((total / safeMax) * 180).clamp(8, 180).toDouble();
